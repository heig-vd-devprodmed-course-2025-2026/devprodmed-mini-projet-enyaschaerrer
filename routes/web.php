...
// J'ai donc choisi Route::resource pour toutes mes routes car ça jouait bien et je trouvais le plus simple syntaxiquement à comprendre.
Route::resource('saved-posts', SavedPostController::class)->only(['index', 'destroy', 'store'])->middleware('auth');
